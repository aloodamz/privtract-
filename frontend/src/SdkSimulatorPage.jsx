...
export default function SdkSimulatorPage() {
  ...
  function CryptoJS_mock_sha256(str) {
    // Generate simple deterministic hashes for display using standard string offsets
    ...
    const mockHash = (h1.toString(16) + h2.toString(16)).padStart(16, "0");
    return mockHash + mockHash + mockHash + mockHash; // expand to 64 chars
  }

  function CryptoJS_mock_blake3(str) {
    // Salted mock for blake3
    return CryptoJS_mock_sha256("blake3-salt-key-928374982734982:" + str);
  }
